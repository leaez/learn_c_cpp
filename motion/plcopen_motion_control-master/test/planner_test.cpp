...
protected:
                      ...
                      std::string file_name = "scurve.png")
  {
    ...
    try {
        ...
        plt.attr("subplot")(4, 1, 1);
        plt.attr("plot")(t, pos,"r-");
        plt.attr("ylabel")("Position");
        plt.attr("grid")(true);


        plt.attr("subplot")(4, 1, 2);
        plt.attr("plot")(t, vel,"b-");
        plt.attr("ylabel")("vel");
        plt.attr("grid")(true);

        plt.attr("subplot")(4, 1, 3);
        plt.attr("plot")(t, acc,"g-");
        plt.attr("ylabel")("acc");
        plt.attr("grid")(true);

        plt.attr("subplot")(4, 1, 4);
        plt.attr("plot")(t, jerk,"b-");
        plt.attr("ylabel")("jerk");
        plt.attr("grid")(true);
